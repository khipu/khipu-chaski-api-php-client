...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://chaski.khipu.com/api/1.0';
     ...
     * @var string
     */
    protected $userAgent = "khipu-api-php-client/1.1.2";
    ...
    {
        $this->userAgent = "khipu-api-php-client/1.1.2|".$name."/".$version;
    }
    ...
    {
        $report  = "PHP SDK (KhipuChaski) Debug Report:\n";
        $report .= "    OS: ".php_uname()."\n";
        $report .= "    PHP Version: ".phpversion()."\n";
        $report .= "    Swagger Spec Version: 1.1.2\n";
