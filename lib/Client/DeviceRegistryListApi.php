...
/**
 * DeviceRegistryListApi Class Doc Comment
 *
 * @category Class
 * @package  KhipuChaski
 * @author   http://github.com/swagger-api/swagger-codegen
...
class DeviceRegistryListApi
{
     ...
     * @return \KhipuChaski\Model\DeviceList
     * @throws \KhipuChaski\ApiException on non-2xx response
     */
    public function getDevices($options = null)
    {
        ...
        try
        {
            list($response, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\KhipuChaski\Model\DeviceList'
            );
            ...
            return $this->apiClient->getSerializer()->deserialize($response, '\KhipuChaski\Model\DeviceList', $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\KhipuChaski\Model\DeviceList', $e->getResponseHeaders());
     ...
     * @throws \KhipuChaski\ApiException on non-2xx response
     */
    public function getRecipientDevices($recipient_id, $options = null)
    {
        
        // verify the required parameter 'recipient_id' is set
        if ($recipient_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $recipient_id when calling getRecipientDevices');
        }
  
        // parse inputs
        $resourcePath = "/recipients/{recipientId}/devices";
        $resourcePath = str_replace("{format}", "json", $resourcePath);
        $method = "GET";
        $httpBody = '';
        $queryParams = array();
